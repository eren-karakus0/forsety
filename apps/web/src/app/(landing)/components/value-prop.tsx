...
export function ValueProp() {
  return (
    <section className="section-fullscreen relative overflow-hidden bg-white">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        <ScrollReveal>
          <FadeIn className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-4 font-display text-3xl font-bold text-navy-900 sm:text-4xl lg:text-5xl">
              AI Uses Your Data.{" "}
